...
Característica: CPM00050_Elegir productos de plan - criterios de aceptación (elegir productos de plan)
...
Escenario: Escenario1_Validar contenido sección Etapa 3
  ...
  * Existe botón "No quiero este plan propuesto"
  * Existe botón "Continúe" equipos
