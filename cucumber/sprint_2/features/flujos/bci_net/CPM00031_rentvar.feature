...
Característica: CPM00031_Ingresar Renta Variable Prospecto (Viaje Presencial)
Ingresar al sitio de "Bcinet" de Bci con Rut y Código de Seguimiento, se debe ingresar a la etapa 2 "Detalle su perfil" el tipo de renta Variable y monto de Renta Líquida Mensual del Prospecto.
...
Antecedentes:
  ...
  * Se despliega el campo rut, codigo de seguimiento y el botón Ingresar
  ...
  * Selecciona tipo de ingreso variable bcinet seguimiento
